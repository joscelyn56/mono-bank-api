...
router.post('/', jwt_1.authenticate, checkSchema(account_validator_1.createCreateAccountSchema), accountController.create);
router.post('/deposit', jwt_1.authenticate, checkSchema(account_validator_1.createDepositSchema), accountController.deposit);
